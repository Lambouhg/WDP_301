            ...
            <div className="flex bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
                ...
                <div className="flex-1 p-6 flex justify-center items-center">
                    <div className="bg-white p-8 rounded-xl shadow-lg max-w-md text-center">
                        <h1 className="text-3xl font-bold text-gray-800 mb-4 tracking-wide">Company Not Found</h1>
                        <p className="text-gray-600">The company you requested does not exist or has not been created.</p>
                    </div>
                </div>
            </div>
        );
        ...
        <div className="flex bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
            ...
            <div className="overflow-y-auto w-full h-screen pb-10">
                <div className="w-full mt-6 px-4 border-b-2 border-gray-200 mb-12">
                    <DashboardHeader dashboardHeaderName={"Company Detail"} onBack={handleBack} />
                </div>

...
import { ArrowLeft, ChevronDown, FileText, Briefcase, PieChart } from "lucide-react";
import SidebarCompany from "../../components/SidebarCompany";
import HeaderCompany from "../../components/HeaderCompany";
import { useRouter } from "next/router";

// Define the SVG path data as constants
const EDIT_ICON_PATH = "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z";
const DELETE_ICON_PATH = "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16";
...
const JobDetails = () => {
    ...
    const tabs = [
        { key: "applicants", label: "Applicants", icon: <Briefcase className="w-5 h-5" />, path: "/company/ApplicantsTracking" },
        { key: "details", label: "Job Details", icon: <FileText className="w-5 h-5" />, path: null },
        { key: "analytics", label: "Analytics", icon: <PieChart className="w-5 h-5" />, path: "/company/Analytics" },
    ];
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    ...
                                    <div className="p-6 space-y-8">
                                        <div>
                                            <h3 className=" text-lg block mb-1 font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Description</h3>
                                        ...
                                        <div>
                                            <h3 className=" text-lg block mb-1 font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Responsibilities</h3>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div>
                                            <h3 className=" text-lg block mb-1 font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Who You Are</h3>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <p className="text-gray-700 whitespace-pre-line">{job.whoYouAre}</p>
                                            </div>
                                        </div>

                                        <div>
                                            <h3 className=" text-lg block mb-1 font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Perks & Benefits</h3>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <div className="flex flex-wrap gap-2">
                            ...
                            <div className="space-y-6">
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="p-6 border-b">
                                        <h3 className=" text-lg block mb-1 font-semibold bg-gradient-to-r from-gray-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">About this role</h3>
                                    </div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <div className="text-sm text-gray-500 mb-1">Apply Before</div>
                                                <div className="font-medium">{new Date(job.dueDate).toLocaleDateString()}</div>
                                            </div>
                                            <div>
                                                <div className="text-sm text-gray-500 mb-1">Job Posted On</div>
                                                <div className="font-medium">{new Date(job.datePosted).toLocaleDateString()}</div>
                                            </div>
                                            <div>
                                            ...
                                            <div className="col-span-2">
                                                ...
                                                <div className="font-medium text-green-700">${job.salaryMin} - ${job.salaryMax} USD</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="p-6 border-b">
                                        <h3 className="block mb-1 font-semibold bg-gradient-to-r from-gray-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Categories</h3>
                                    </div>
                                    <div className="p-6">
                                        <div className="flex flex-wrap gap-2">
                                            {job.categories.map((category, index) => (
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="p-6 border-b">
                                        <h3 className="block mb-1 font-semibold bg-gradient-to-r from-gray-500 to-purple-600 text-transparent bg-clip-text py-2 hover:scale-105 transition-transform duration-300 ease-in-out">Required Skills</h3>
                                    </div>
                                    <div className="p-6">
    <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white rounded-lg w-full max-w-2xl p-6 space-y-4 overflow-y-auto max-h-[85vh]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(updatedData.requiredSkills || []).map(
                        (skill, index) => (
                          <span
                            key={index}
                            ...
                            <button
                              ...
                              onClick={() => {
                                setUpdatedData({
                                  ...updatedData,
                                  requiredSkills:
                                    updatedData.requiredSkills.filter(
                                      (_, i) => i !== index
                                    ),
                                });
                              }}
                    ...
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
                        <div className="relative max-w-lg p-4 mx-auto mt-24">
                            <div className="bg-white rounded shadow-md p-8">
                                ...
                                <p className="text-gray-700 mb-6">Are you sure you want to delete this job listing? This action cannot be undone.</p>

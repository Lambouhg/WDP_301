...
const initialMembers = [
  { name: "Célestin Gardinier", role: "CEO & Co-Founder", image: "/avatar1.jpg" },
  { name: "Reynaud Colbert", role: "Co-Founder", image: "/avatar2.jpg" },
  { name: "Arienne Lyon", role: "Managing Director", image: "/avatar3.jpg" },
  { name: "Bernard Alexander", role: "Managing Director", image: "/avatar4.jpg" },
  { name: "Christine Jhonson", role: "Managing Director", image: "/avatar5.jpg" },
...
const CompanyTeam = () => {
  ...
  const [newMember, setNewMember] = useState({ name: "", role: "", image: "/default-avatar.jpg" });
      ...
      <div className="w-full px-10 pt-5 h-full overflow-y-auto py-8">
        ...
        <div className="w-full mx-auto py-7">
          <header className="bg-white rounded-2xl shadow-sm mb-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">LIST TEAM MEMBERS</h1>
          ...
          <div className="w-3/4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {members.map((member, index) => (
                ...
                >
                  <img src={member.image} alt={member.name} className="w-20 h-20 rounded-full object-cover mb-4"/>
                  <h3 className="font-medium">{member.name}</h3>
                  <p className="text-gray-500 text-sm">{member.role}</p>
                  <div className="flex justify-center space-x-2 mt-4">
                    <FaLinkedin className="text-gray-500 hover:text-blue-600" size={22} />
                    <FaFacebook className="text-gray-500 hover:text-blue-600" size={22} />
                  </div>
